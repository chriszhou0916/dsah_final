...
# In[2]:
query_string="SELECT * FROM labevents"
...
query_string="SELECT * FROM chartevents"
...
query_string="SELECT * FROM outputevents"
...
query_string="SELECT * FROM diagnoses_icd"
...
feature_table.to_csv("./data/feature_with_label_all.csv",index=None, header=True)
